    ...
    <main className="flex min-h-screen flex-col items-center justify-start relative overflow-hidden bg-black">
      ...
      <section className="relative z-10 max-w-7xl w-full flex flex-col lg:flex-row items-center gap-12 mt-32 lg:mt-48 px-6 md:px-12">
        <div className="flex-1 text-center lg:text-left">
          ...
          >
            <OpenModalButton showIcon className="px-10 py-4 bg-purple-600 hover:bg-purple-700 text-white rounded-xl font-bold transition-all neon-border flex items-center justify-center gap-2 group shadow-[0_0_20px_rgba(139,92,246,0.3)]" />
             ...
             <div className="flex -space-x-3">
                {[1,2,3,4].map(i => (
                  <div key={i} className="w-10 h-10 rounded-full border-2 border-black bg-gray-800 overflow-hidden relative">
                    <Image src={`/assets/testimonial-${i === 1 ? 'ceo' : 'entrepreneur'}.png`} alt="User" fill className="object-cover" />
                  </div>
                ))}
             </div>
